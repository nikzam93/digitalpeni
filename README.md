.ve-header "Ψηφιακές Οικολογίες" wc:The_beautiful_white_rose_flower.jpg "Η χρήση του ψηφιακού εργαλείου Juncture στη Νεοελληνική Ποίηση του 19ου-20ού αιώνα"
    - [Αρχική](/)
...
![](https://digitalpeni.org/images/NKUA_logo.png){style=height:100px} Φιλοσοφική Σχολή, Τμήμα Φιλολογίας ![](https://digitalpeni.org/images/post-doc-logo.png){style=height:100px} Με την ευγενική υποστήριξη των ![](https://digitalpeni.org/images/jstor-labs-logo.png){style=height:60px}
